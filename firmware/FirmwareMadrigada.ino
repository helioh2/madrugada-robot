...
#define BAUD            (9600)//mudou tava 57600
...
void processCommand() {
  ...
  case 1: {  // line
    ...
    Serial.println("case 1 OUT");
    break;
  }
  case 2:
  case 3: {  // arc
    Serial.println("case 3 IN");
    Vector3 offset=get_end_plus_offset();
    setFeedRate(parseNumber('F',feed_rate));
...
void setup_turtle() {
  ...
  String commands[] = {  "M101 T15 B-15 L-25 R25 I1 J-1",  "D1 L1.273",  "G92 X0.0 Y0.0", 
  "D6 X0 Y0.0", "G0 F6500 A80", "M17", "G91"};

  //String commands[] = {  "M101 T15 B-15 L-25 R25 I1 J-1",  "D1 L1.273",  "G92 X0.0 Y-67.0009994506836", 
    //                          "D6 X0 Y-67.001", "G0 F6500 A80", "M17", "G91"};
...
void sendCommand(String command) {
  ...
  strlcpy(serialBuffer, command.c_str(), MAX_BUF+1);
  sofar = command.length();
  Serial.println(serialBuffer);
